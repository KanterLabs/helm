#!/usr/bin/env python3
"""Focused tests for the TC Roadmap lifecycle hook adapter."""
...
import tc_roadmap_hook as hook
...
class HookTests(unittest.TestCase):
    ...
    def test_compact_session_start_injects_safe_recovery_context(self) -> None:
        with tempfile.TemporaryDirectory() as raw:
            ...
            result = hook.handle_event(
                ...
                notes_fn=lambda _state: "Active agent notes (review before continuing):\n- [Known issue] Avoid the rejected path.",
            )
            context = result["hookSpecificOutput"]["additionalContext"]
            self.assertIn("Recovered Roadmap task TC-1", context)
            ...
            self.assertIn("Avoid the rejected path", context)
    ...
    def test_heartbeat_is_throttled_and_uses_only_safe_call(self) -> None:
        with tempfile.TemporaryDirectory() as raw:
            ...
            with mock.patch.dict("os.environ", {"TC_ROADMAP_HEARTBEAT_INTERVAL_SECONDS": "480"}, clear=False):
